...
let loadButtonWrapper = document.querySelector(".magxpress-load-posts-btn-wrapper");
let loadButton = document.querySelector(
    ".magxpress-load-posts-btn-wrapper .load-btn"
);
let loader = document.querySelector(".magxpress-ajax-loader");
let articleWrapper = document.querySelector(".magxpress-article-wrapper");
    ...
    fetchThePosts: function () {
        ...
        fetch(MagxpressVars.ajaxurl, {
            ...
            body: new URLSearchParams({
                action: "magxpress_load_posts",
                nonce: MagxpressVars.nonce,
                query_vars: MagxpressVars.query_vars,
                page: nextPage,
            }),
        })
            .then((response) => {

...
$related_posts_text = magxpress_get_option('related_posts_text');
$no_of_related_posts = absint(magxpress_get_option('no_of_related_posts'));
$order = esc_attr(magxpress_get_option('related_posts_order'));
$orderby = esc_attr(magxpress_get_option('related_posts_orderby'));

...
$author_posts_text = magxpress_get_option('author_posts_text');
$no_of_author_posts = absint(magxpress_get_option('no_of_author_posts'));
$order = esc_attr(magxpress_get_option('author_posts_order'));
$orderby = esc_attr(magxpress_get_option('author_posts_orderby'));

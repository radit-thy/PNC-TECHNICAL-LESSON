<template>
  <div class="container mt-4">
    <div class="row">
      <div class="col-md-4 mb-4" v-for="teacher in teachers" :key="teacher">
        <div class="card" >
          ...
          <div class="card-body">
            ...
            <p class="card-text">Scores: {{teacher.score}}</p>
            <p class="text-danger" v-if="teacher.score < 50" style="color:red">Fail </p>
            <p class="text-primary" v-if="teacher.score > 50" style="color:blue">Pass</p>
          </div>
        </div>
      </div>
    </div>
